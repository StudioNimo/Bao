...
- **Code:** [`src/cmd_eval.c`](../src/cmd_eval.c) (option parsing today rejects `--json` before DB open), [`src/db.h`](../src/db.h) / [`src/db.c`](../src/db.c) (`bao_uneval_exec_t`, `bao_db_insert_evaluation`).
- **Tests:** Extend [`tests/stub_options_fail.sh`](../tests/stub_options_fail.sh) or add a small integration test that feeds fake stdin once `--json` exists.
...
- **Code:** [`src/cmd_remote.c`](../src/cmd_remote.c) (`stub_push`, `stub_pull`), `.bao/` layout in [`architecture.md`](architecture.md).
...
- **Code:** [`src/cmd_run.c`](../src/cmd_run.c) (provider check ~line 207; OpenAI HTTP in `openai_chat_completion`), [`src/config.c`](../src/config.c) / `bao.yaml` parsing.
